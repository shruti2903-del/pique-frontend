    ...
    >
      <nav className="navbar d-flex flex-column align-items-center">
        ...
        <div className="navbar-nav text-start w-100">
          ...
          <NavLink to="/user/" className={({ isActive }) => `nav-link ${isActive ? "text-danger fw-bold" : ""}`}>
            <i className="fa-solid fa-gauge me-2"></i> Dashboard
          </NavLink>

          <NavLink to="/user/all" className={({ isActive }) => `nav-link ${isActive ? "text-danger fw-bold" : ""}`}>
            <i className="fa-solid fa-clipboard-list me-2"></i> All Venues
          </NavLink>

         
          <NavLink to="/user/entertainers" className={({ isActive }) => `nav-link ${isActive ? "text-danger fw-bold" : ""}`}>
            <i className="fa-solid fa-location-dot me-2"></i> All Entertainer
          </NavLink>

          <NavLink to="/user/bookings" className={({ isActive }) => `nav-link ${isActive ? "text-danger fw-bold" : ""}`}>
            <i className="fa-solid fa-list-check me-2"></i> All Bookings
          </NavLink>

          <NavLink to="/user/calendar" className={({ isActive }) => `nav-link ${isActive ? "text-danger fw-bold" : ""}`}>
