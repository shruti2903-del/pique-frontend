    ...
    try {
      ...
      if (response.data.status) {
        ...
        setVenues((prevVenues) => ({
          ...prevVenues,
          children: prevVenues.children.map((venue) =>
  ...
  const handleDeleteVenue = async (venueId) => {
    ...
    try {
      ...
      if (response.data.status) {
        ...
        setVenues((prevVenues) => ({
          ...prevVenues,
          children: prevVenues.children.filter((venue) => venue.id !== venueId),
        }));
      } else {
        ...
        <div className="table-responsive">
          <table className="table">
            ...
            <tbody className="profile-font text-secondary">
              {venues.children.map((venue, index) => (
                <tr key={venue.id}>
                  <td>{index + 1}</td>
                  ...
                  <td>
                    <Button
                      className="btn btn-warning rounded-5 btn-sm"
                      onClick={() => handleEditClick(venue)}
                    >
                      <i className="fa-solid fa-pen-to-square"></i>
                    </Button>
                    <Button
                      className="btn btn-danger rounded-5 ms-1 btn-sm"
                      onClick={() => {
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  {isLoading ? (
                    ...
                    <p className="profile-font">Are you sure you want to delete this venue?</p>
                  )}
                </div>
                <div className="modal-footer">
                  <Button
