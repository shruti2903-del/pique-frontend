...
export default function VenueProfile() {
        ...
        useEffect(() => {
          const fetchVenueData = async () => {
            ...
            try {
              ...
              console.error("Error fetching venue data:", err.response || err.message);
            }
          };
  ...
  return (
    <>
      <Helmet>
        <title>Profile</title>
        <meta name="description" content="Add your venue details." />
      </Helmet>
        ...
        <div className="content">
          ...
          <div className="row">
            <div className="col-md-12 mt-4">
              <h2 className="text-secondary text-center mb-3">Profile</h2>
